...
|========|===============|=======|=============
| 3..0 | Posición anterior | 0..15 | Índice de esta entrada en la tabla en el último arranque. Se utiliza para actualizar la prioridad de IPL o BCV si se realiza la detección individual de dispositivos.
|--------|-------------- |-------|-------------
| 7..4 | (Reservado) | 0 | Reservado para uso futuro; debe ser cero.
|--------|-------------- |-------|-------------
| 8 | Habilitado | 0..1 | 0 = Esta entrada se ignorará durante el arranque (IPL); no se invocará para la conexión de arranque (BCV).
...
|--------|---------------|-------|-------------
| 11..10 | Medios presentes | 0..3 | 0 = No hay medios de arranque presentes en el dispositivo.
| | | | 1 = Se desconoce si hay medios de arranque presentes.
| | | | 2 = Hay medios presentes y parecen ser de arranque.
| | | | 3 = Reservado para uso futuro.
|--------|---------------|-------|-------------
| 15..12 | (Reservado) | 0 | Reservado para uso futuro, debe ser cero&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
